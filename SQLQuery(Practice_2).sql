...
select DATEADD(YEAR,1,'2025-01-01'),DATEADD(YY,1,'2024-01-01'),
DATEADD(YYYY,1,'2025-01-01'),DATEADD(month,3,'2024-01-01'),
DATEADD(week,1,'2024-01-01'),DATEADD(WEEKDAY,1,'2024-01-01')

select DATEDIFF(YEAR,'2024-02-01','2025-02-01')as Year1,
DATEDIFF(YY,'2024-02-01','2025-02-01')as Year2,
DATEDIFF(YYYY,'2024-02-01','2025-02-01')as Year3,
		DATEDIFF(Q,'2024-02-01','2025-02-01')as Quarter1,
		DATEDIFF(QQ,'2024-02-01','2025-02-01')as Quarter2,
		DATEDIFF(QUARTER,'2024-02-01','2025-02-01')as Quarter3,
				DATEDIFF(M,'2024-02-01','2025-02-01')as Month1,
				DATEDIFF(MM,'2024-02-01','2025-02-01')as Month2,
				DATEDIFF(MONTH,'2024-02-01','2025-02-01')as Month3,
						DATEDIFF(D,'2024-02-01','2025-02-01')as Day1,
						DATEDIFF(DD,'2024-02-01','2025-02-01')as Day2,
						DATEDIFF(DY,'2024-02-01','2025-02-01')as Day3,
						DATEDIFF(DAY,'2024-02-01','2025-02-01')as Day4,
						DATEDIFF(DAYOFYEAR,'2024-02-01','2025-02-01')as Day5,
						DATEDIFF(WEEKDAY,'2024-02-01','2025-02-01')as Day6,
						DATEDIFF(WEEK,'2024-02-01','2025-02-01')as Week1;
